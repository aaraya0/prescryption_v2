...
const { issuePrescription, getPresbyDoctorNid, getAllPrescriptions, getPresbyPatientAddress, sendPrescriptionToPharmacy, getPresbyPharmacyAddress } = require('./prescriptionController');
